...
class AboutAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Global Hero Settings", {"fields": ("hero_typed_text",)}),
        (
...
class EducationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Academic Details", {"fields": ("title", "institute_name", "subject")}),
        ("Duration & Status", {"fields": ("start_date", "end_date", "is_ongoing")}),
    )
    ordering = ("-start_date",)
...
class ExperienceAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Job Overview", {"fields": ("role", "company_name")}),
        ("Timeline", {"fields": ("start_date", "end_date", "is_ongoing")}),
        (
